...
Shader "Archanor VFX/Epic Toon FX/ETFX_PowerboxUnlit"
{
	Properties
	{
		...
		[ASEEnd]_IconOffset("Icon Offset", Vector) = (0,-1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord45 = IN.ase_texcoord3.xy * temp_cast_1 + _IconOffset.xy;
...
ASEEND*/
//CHKSM=059D626C6EB318770B73458D9F7D5C6F9417940C